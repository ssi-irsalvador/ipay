...
<fieldset class="themeFieldset01" style="background: #FAD163; border-radius: 4px 4px 0 0;"><h2 style="margin: 0 0 -5px 0;">Loan Information</h2></fieldset>
<fieldset class="themeFieldset01">
<!--<legend class="themeLegend01">Loan Balance List</legend>-->
<form method="post" action="">
<table width="532" border="0" cellpadding="2" cellspacing="0">
  <tr>
    <td width="37%">&nbsp;&nbsp;&nbsp;&nbsp;<strong><em>Company</em></strong></td>
  ...
  <tr>
    ...
    <td colspan="5"><!--<select name="emp_type" id="emp_type" class="longselect">
      ...
      <select name="status" id="status" class="longselect">
