...
<fieldset class='themeFieldset01' style='background: #FAD163; border-radius: 4px 4px 0 0;'><h2 style='margin: 0 0 -5px 0;'>Amendments Import</h2></fieldset>
<form method="post" enctype="multipart/form-data" action="">
<fieldset class='themeFieldset01'>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr bgcolor="#FAD163">
	  <td colspan="2" style="height:19px"><strong>Upload Amendments Information</strong></td>
	  </tr>
	<tr>
		<td width="110" class="divTblTH_">&nbsp;</td>
		<td class="divTblTH_"><strong class="longlabel">Select Payperiod <span class="style5">*</span></strong>
	...
	<tr>
	  <td class="divTblTH_ style3 style4"><div align="left"></div></td>
	  <td class="divTblTH_ style3 style4"><div align="left">&bull; <em>Sample XLS file:&nbsp;<a href="importtemplate/AmendmentTemplate.xls" target="_blank">Download</a></em></div></td>
	</tr>
</table>
</fieldset>
</form>
