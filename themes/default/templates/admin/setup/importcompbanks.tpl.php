...
<legend class="themeLegend01">Company Banks XLS Import</legend>
<form method="post" enctype="multipart/form-data" action="">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr bgcolor="#FAD163">
	  <td colspan="2" style="height:19px"><b>Upload Company Bank Information</b></td>
	  </tr>
	<tr>
		<td width="110" class="divTblTH_">&nbsp;</td>
		<td class="divTblTH_"><b class="longlabel">Select File <span class="style5">*</span></b>
		  <input type="file" name="uptahead_file"></td>
	</tr>
	<tr>
	...
	<tr>
	  <td class="divTblTH_ style3 style4"><div align="left"></div></td>
	  <td class="divTblTH_ style3 style4"><div align="left">&bull; <em>Sample XLS file:&nbsp;<a href="importtemplate/CompanyBankTemplate.xls" target="_blank">Download</a></em></div></td>
	</tr>
</table>
</form>
</fieldset>
