...
<legend class="themeLegend01">Dependens XLS Import</legend>
<form method="post" enctype="multipart/form-data" action="">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr bgcolor="#FAD163">
	  <td colspan="2" style="height:19px"><b>Upload 201 Dependents Information</b></td>
	  </tr>
	<tr>
	...
	<tr>
	  <td class="divTblTH_ style3 style4"><div align="left"></div></td>
	  <td class="divTblTH_ style3 style4"><div align="left">&bull; <em>Sample XLS file:&nbsp;<a href="importtemplate/EmployeesDependents.xls" target="_blank">Download</a></em></div></td>
	</tr>
</table>
</form>
</fieldset>
