...
<table width="100%" border="0" cellpadding="1" cellspacing="2">
    <tr>
      <td width="30%" class="divTblTH_"><div align="right"><span class="style3">Classification</span> &nbsp;&nbsp;</div></td>
      <td width="70%" class="divTblTH_"><input name="empclass_name" id="empclass_name" value="<?=trim($oData['empclass_name'])?>" type="text" size="30" /></td>
    </tr>
    <tr>
      <td class="divTblTH_"><div align="right"><span class="style3">Order</span> &nbsp;&nbsp;</div></td>
      <td class="divTblTH_"><input name="empclass_ord" id="empclass_ord" value="<?=trim($oData['empclass_ord'])?>" type="text" size="10" /></td>
    </tr>
    <tr>
      ...
      <td class="divTblTH_"><input type="submit" name="Submit" value="<?php if(isset($_GET['edit'])){ echo 'Update & Clear'; }else{ echo 'Save & Clear'; } ?>" class="buttonstyle" />
        ...
        <input type="button" name="Cancel" value="Cancel" class="buttonstyle" onclick="javascript:window.location='setup.php?statpos=empclasify'" /><?php } else{?>
