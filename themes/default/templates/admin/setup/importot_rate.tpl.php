...
<fieldset class="themeFieldset01" style="background: #FAD163; border-radius: 4px 4px 0 0;"><h2 style="margin: 0 0 -5px 0;">Import OT Rate</h2></fieldset>
<fieldset class="themeFieldset01">
<!--<legend class="themeLegend01">OT Rate's XLS Import</legend>-->
<form method="post" enctype="multipart/form-data" action="">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr bgcolor="#FAD163">
	  <td colspan="2" style="height:19px"><b>Upload OT Rate Information</b></td>
	  </tr>
	<tr>
		<td width="110" class="divTblTH_">&nbsp;</td>
		<td class="divTblTH_"><b class="longlabel">Select File <span class="style5">*</span></b><input type="file" name="uptahead_file" accept="application/vnd.ms-excel"></td>
	</tr>
	<tr>
	...
	<tr>
	  <td class="divTblTH_ style3 style4"><div align="left"></div></td>
	  <td class="divTblTH_ style3 style4"><div align="left">&bull; <em>Sample XLS file:&nbsp;<a href="importtemplate/OTRatesTemplate.xls" target="_blank">Download</a></em></div></td>
	</tr>
</table>
</form>
</fieldset>
