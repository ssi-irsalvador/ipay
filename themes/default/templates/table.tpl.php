 ...
 <!--Autocomplete Condition-->
        ...
        <div>
	        ...
	        <div style="font-size:13px; margin: 15px; float:left;">
		        ...
		        <select name="search_status" style="width:153px;">
		        	<option value="">All</option>
		        	<?php foreach($empStat as $keyStat => $valStat){
		        		echo "<option value=\"".$valStat['emp201status_id']."\">".$valStat['emp201status_name']."</option>";
					} ?>
		        </select>
        	</div>
        </div>
