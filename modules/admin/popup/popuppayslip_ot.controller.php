...
$cmap = array(
"default" => "popuppayslip_ot.tpl.php"
,"assign" => "popuppayslip_ot.tpl.php"
,"edit" => ""
);
...
//				printa($objClsProcess_Payroll->Data);
				...
				$objClsProcess_Payroll->doPopulateData($_POST);
				$objClsProcess_Payroll->doSaveOT($_GET['emp_id'],$_GET['psdetail'],$_POST);
				header("Location: popup.php?statpos=popuppayslip_ot&emp_id=".$_GET['emp_id']."&psdetail=".$_GET['psdetail']);
				exit;
			}
		}else{
//			$centerPanelBlock->assign('tblDataList',$objCls_addotrates->getpopup_OTrate($_GET['emp_id']));
			$centerPanelBlock->assign('tblDataList',$objClsProcess_Payroll->getpopup_OTrate($_GET['emp_id'],$_GET['psdetail']));
